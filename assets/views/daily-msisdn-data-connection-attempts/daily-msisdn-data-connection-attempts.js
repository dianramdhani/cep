(function () {
    ...
    // Usage:
    // Daily MSISDN Data Connection Attempts view.

    window.app
        .component('dailyMsisdnDataConnectionAttempts', {
            template: require('./daily-msisdn-data-connection-attempts.html'),
            controller: _
        });
